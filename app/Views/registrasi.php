...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(to right, #a4c0f7, #ecf0f1);
            /* Gradient from light blue to light gray */
        }

        h1 {
            color: #2c3e50;
            /* Dark blue text color for the heading */
            text-align: center;
            color: #333;
            margin-bottom: 20px;
        }
        ...
        form {
            ...
            /* Adding a subtle shadow to the form */
        }
        ...
        .navbar-toggler-icon {
            ...
            /* White color for the navbar toggler icon */
        }
